...
menu_Dr_Hladik_EP1 = [
	...
	[["FoodBioMeat","ItemZombieParts",2,1,"buy","Zombie Parts","Bio Meat",101]],
	"neutral"
];
menu_Doctor = [
	[["Chemlites / Flares",669],["Medical Supplies",670],["Smoke Grenades",671]],
...
menu_RU_Profiteer4 = [
	[["Bikes And Atv",587],["Buses And Vans",588],["Cargo Trucks",586],["Fuel Trucks",589],["Military Unarmed",598],["Trucks",590],["Used Cars",520],["Utility Vehicles",591],["Overwatch Civ Car",1015],["Overwatch Nissian Car",1016],["Overwatch",2000]],
	[],
	"neutral"
];
...
---------------------------------------------------------------------------*/
menu_RU_Citizen1 = [
	[["Wholesale",636],["BuildingSupplies",662]],
	[],
	"neutral"
];
...
menu_RU_Functionary2 = [
    [["Coin/Gold Exchange",700],["Black Market Weapons",526],["Black Market Ammo",527],["Explosives",529]],
    [],
    "neutral"
];