...
class CfgBuildingLoot {
	...
	class Castle : Default {
		lootChance = 0.1;
		lootPos[] = {};
		lootType[] = {{"ItemKnife", "weapon", 0.01}, {"ItemCompass", "weapon", 0.01}, {"ItemFlashlight", "weapon", 0.01}, {"WeaponHolder_ItemHatchet", "object", 0.01}, {"WeaponHolder_ItemTent", "object", 0.01}, {"PartWoodPile", "magazine", 0.04}, {"", "generic", 0.4}};
	};
	...
	class Industrial : Default {
		...
		lootTypeSmall[] = {{"", "generic", 0.5}, {"", "trash", 0.01}, {"", "military", 0.5}, {"ItemKnife", "weapon", 0.07}, {"ItemKeyKit", "weapon", 0.01}, {"ItemMixOil", "magazine", 0.2}};
	};
	...
	class IndustrialFuel : Default {
		...
		lootTypeSmall[] = {{"", "generic", 0.5}, {"", "trash", 0.01}, {"", "military", 0.5}, {"ItemKnife", "weapon", 0.07}, {"ItemKeyKit", "weapon", 0.01}, {"ItemMixOil", "magazine", 0.02}};
	};
	...
	class Farm : Default {
		...
		lootTypeSmall[] = {{"", "generic", 0.79}, {"", "trash", 0.01}, {"", "military", 0.5}, {"ItemLightBulb", "magazine", 0.01}, {"ItemSledgeHead", "magazine", 0.01}, {"ItemMixOil", "magazine", 0.1}};
	};
	...
	class Supermarket : Default {
		...
		lootTypeSmall[] = {{"ItemSodaMdew", "magazine", 0.1}, {"ItemSodaRbull", "magazine", 0.01}, {"ItemSodaOrangeSherbet", "magazine", 0.03}, {"ItemWatch", "weapon", 0.07}, {"ItemCompass", "weapon", 0.03}, {"pistols", "cfglootweapon", 0.5}, {"ItemFlashlight", "weapon", 0.01}, {"ItemKnife", "weapon", 0.02}, {"ItemMatchbox_DZE", "weapon", 0.04}, {"", "generic", 0.21}, {"", "food", 0.4}, {"", "trash", 0.01}, {"Binocular", "weapon", 0.02}, {"ItemMixOil", "magazine", 0.05}};
	};
	...
	lootChance = 1;
	lootPos[] = {};
	lootType[] = {{"ItemFlashlight", "generic", 0.01}, {"ItemKnife", "generic", 0.01}, {"ItemMatchbox_DZE", "generic", 0.03}, {"farmweapons", "cfglootweapon", 0.7}, {"", "military", 0.5}, {"WeaponHolder_ItemMachete", "object", 0.02}, {"", "hunter", 0.5}};
	lootTypeSmall[] = {{"ItemFlashlight", "weapon", 0.02}, {"ItemKnife", "weapon", 0.02}, {"ItemMatchbox_DZE", "weapon", 0.04}, {"", "military", 0.4}, {"", "hunter", 0.5}};
	};
