...
{
systemchat "RELOG to pack again. You cant dismantle your safe if a player or a zombie is within 15 meters.";
};
...
if(!isNull _obj && alive _obj) then {
	...
	_countr = 0;
	{
		_dcarr = [_x,(_objWpnQty select _countr)];
		_holder addweaponcargoGlobal _dcarr;
		_countr = _countr + 1;
	} count _objWpnTypes;
