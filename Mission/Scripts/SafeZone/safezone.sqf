...
USE_SPEEDLIMIT = False;  // very secret function, nobody is supposed to find out what it does.
        SPEEDLIMIT = 90;                // Only used if USE_SPEEDLIMIT is true.
...
_infiSZ =
[
[[8031.5,2901.73,0.00153399],55,true], //Boat dealer

        [[4063.4226,11664.19,0],175,true], //Bash
        [[11447.472,11364.504,0],175,true], //Klen 
		[[12890.1,4462.49,0.],230,true] //Tulga
...
[_infiSZ] spawn {
        ...
        _endSafeZone =
        {
                if (isNil 'inNow') then
                {
                        ...
                        {
                                _msg = 'YOU HAVE LEFT ANY PROTECTION OUTSIDE BUBBLES!';
                                hint _msg;
