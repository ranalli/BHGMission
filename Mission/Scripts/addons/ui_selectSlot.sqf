				...
				if (alive _x) then {
					...
					if(_hasKey or _oldOwner) then {
						if(locked _x) then {
							...
							_menu ctrlShow true;
							_text =  "Unlock";
							_script =  "[""" + _ownerID + """] execVM ""Scripts\keys\remote_unlock.sqf""";
							_height = _height + (0.025 * safezoneH);
							uiNamespace setVariable ['uiControl', _control];
							_menu ctrlSetText _text;
							...
							_menu ctrlShow true;
							_text =  "Lock";
							_script =  "[""" + _ownerID + """] execVM ""Scripts\keys\remote_lock.sqf""";
							_height = _height + (0.025 * safezoneH);
							uiNamespace setVariable ['uiControl', _control];
							_menu ctrlSetText _text;
							_menu ctrlSetEventHandler ["ButtonClick",_script];
						...
						if (isEngineOn _x) then {
							...
							_menu ctrlShow true;
							_text =  "Stop";
							_script =  "[""" + _ownerID + """] execVM ""Scripts\keys\remote_start.sqf""";
							_height = _height + (0.025 * safezoneH);
							uiNamespace setVariable ['uiControl', _control];
							_menu ctrlSetText _text;
							_menu ctrlSetEventHandler ["ButtonClick",_script];
						...
						_menu ctrlShow true;
						_text =  "Eject Crew";
						_script =  "[""" + _ownerID + """] execVM ""Scripts\keys\remote_eject.sqf""";
						_height = _height + (0.025 * safezoneH);
						uiNamespace setVariable ['uiControl', _control];
						_menu ctrlSetText _text;
						_menu ctrlSetEventHandler ["ButtonClick",_script];
