// included compiles
call compile preprocessFileLineNumbers "Scripts\addons\bike\config.sqf";
call compile preprocessFileLineNumbers "Scripts\addons\bike\wrapper.sqf";
call compile preprocessFileLineNumbers "Scripts\addons\bike\functions.sqf";
...
player_deploy = compile preprocessFileLineNumbers "Scripts\addons\bike\player_deploy.sqf";
...
[] spawn {
    ...
    // call dependency
    call compile preprocessFileLineNumbers "Scripts\addons\init.sqf";
    ...
    {DZE_CLICK_ACTIONS = DZE_CLICK_ACTIONS + [[(_forEachIndex call getDeployableKitClass),format["Deploy %1",(_forEachIndex call getDeployableDisplay)],format["%1 execVM 'Scripts\addons\bike\deploy.sqf';",_forEachIndex],(_forEachIndex call getDeployableCondition)]];} forEach DZE_DEPLOYABLES;
    DZE_DEPLOYING      = false;
    DZE_PACKING        = false;
            ...
            {   
                ...
                if(!(isNull _cursorTarget)
                    ...
                    if ((_forEachIndex call getActionId) < 0) then {
                        [_forEachIndex,player addaction["<t color='#33b5e5'>" + format["Pack %1",(_forEachIndex call getDeployableDisplay)] + "</t>","Scripts\addons\bike\pack.sqf",[_forEachIndex,_cursorTarget],0,false,true,"", ""]] call setActionId;
                    };
                } else {
