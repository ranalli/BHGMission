...
//Garage
	...
	dayz_spaceInterrupt = compile preprocessFileLineNumbers "Scripts\custom\snap_pro\dayz_spaceInterrupt.sqf";
	...
	player_packVault = compile preprocessFileLineNumbers "Scripts\Fixes\player_packVault.sqf";
	player_unlockVault = compile preprocessFileLineNumbers "Scripts\custom\BuildVectors\compile\player_unlockVault.sqf";
    ...
    snap_build = compile preprocessFileLineNumbers "Scripts\custom\snap_pro\snap_build.sqf";
	...
	//player_unlockDoor = compile preprocessFileLineNumbers "Scripts\Fixes\player_unlockDoor.sqf";
	//player_changeCombo = compile preprocessFileLineNumbers "Scripts\Fixes\player_changeCombo.sqf";
	player_lockVault = compile preprocessFileLineNumbers "Scripts\custom\BuildVectors\compile\player_lockVault.sqf";
	fnc_SetPitchBankYaw = compile preprocessFileLineNumbers "Scripts\custom\BuildVectors\fnc_SetPitchBankYaw.sqf";
	DZE_build_vector_file = "Scripts\custom\BuildVectors\build_vectors.sqf";
	build_vectors = compile preprocessFileLineNumbers DZE_build_vector_file;
	player_updateGui = compile preprocessFileLineNumbers "Scripts\Fixes\player_updateGui.sqf";
	...
	player_wearClothes = compile preprocessFileLineNumbers "Scripts\Fixes\player_wearClothes.sqf";
	...
	fn_gearMenuChecks = compile preprocessFileLineNumbers "Scripts\Fixes\fn_gearMenuChecks.sqf";
	...
	player_build = compile preprocessFileLineNumbers "Scripts\custom\snap_pro\player_build.sqf";
	...
	//player_selectSlot = compile preprocessFileLineNumbers "Scripts\bike\ui_selectSlot.sqf";
	...
	fnc_usec_damageVehicle = compile preprocessFileLineNumbers "Scripts\Fixes\fn_damageHandlerVehicle.sqf";
	...
	vehicle_handleDamage = compile preprocessFileLineNumbers "Scripts\Fixes\vehicle_handleDamage.sqf";
