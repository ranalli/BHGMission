...
if (isServer) then {
	...
	"PVDZE_queryPlotArray" addPublicVariableEventHandler {(_this select 1) spawn server_queryPlotArray};
	"PVDZE_deletePlotArray" addPublicVariableEventHandler {(_this select 1) spawn server_deletePlotArray};
	"PVDZE_plotArray" addPublicVariableEventHandler {(_this select 1) spawn server_plotArray};
