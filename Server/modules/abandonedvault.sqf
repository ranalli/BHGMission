...
_markerRadius = 75; // Radius the loot can spawn and used for the marker
_wait_time = 1800; 
_start_time = time;
...
diag_log("It's rumored there is a survivor safe lost with 0000 as it's code. Go find it!");
