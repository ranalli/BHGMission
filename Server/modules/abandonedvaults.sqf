...
_event_marker2 setMarkerText "Abandoned Player Safe";
...
[nil,nil,"per",rTITLETEXT,"A players safe has been abandoned. Its code is set to 0000. Check your map for the location!","PLAIN DOWN"] call RE;
