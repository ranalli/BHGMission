...
_spawnChance			= 10;				// Percent chance of spawning a crash number between 0 - 100 
_guaranteedLoot			= 8;				// Guaranteed Loot Spawns
_randomizedLoot			= 4;				// Random number of loot piles as well as the guaranteed ones
...
_lootTable				= "MilitarySpecial";		// Name of the loot table the heli gets loot from (DO NOT edit unless you know what your doing)
...
_plane					= false;
_spawnMarker 			= "center";
_heliModel				= ["UH1Y_DZE","UH1H_DZE","MV22","Mi17_DZ","UH60M_EP1","UH1H_TK_EP1"] call BIS_fnc_selectRandom;
