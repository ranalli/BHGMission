if(isServer) then {
	...
	[_mission,_position,"Extreme","Hero Base","MainBandit",true] call mission_init;
	...
	if(_complete) then {
		[_crate,[5,ai_wep_sniper],[5,crate_tools_sniper],[15,crate_items_high_value],[2,crate_backpacks_large]] call dynamic_crate;
	};
