if(isServer) then {
	...
	[_mission,_position,"Extreme",format["Disabled Armed %1",_vehname],"MainBandit",true] call mission_init;
...
//Troops
	...
	[[[(_position select 0) - 20, (_position select 1) + 20, 0]],"random","extreme","bandit","bandit",0,2,"Random","Random",_mission] call spawn_static;
	[[[(_position select 0) + 20, (_position select 1) - 20, 0]],"random","extreme","bandit","bandit",0,2,"Random","Random",_mission] call spawn_static;
	[[[(_position select 0) + 20, (_position select 1) + 20, 0]],"random","extreme","bandit","bandit",0,2,"Random","Random",_mission] call spawn_static;
	[[[(_position select 0) - 20, (_position select 1) - 20, 0]],"random","extreme","bandit","bandit",0,2,"Random","Random",_mission] call spawn_static;
	...
	if(_complete) then {
		[_crate,5,0,[5,crate_items_chainbullets],2] call dynamic_crate;
	};
