...
[nil,nil,rTitleText,"Bandits have Captured a Survivor Medical Camp! Check your map for the location!", "PLAIN",10] call RE;
...
[[(_coords select 0) - 0.5635,(_coords select 1) + 0.3173,0],3,1,"DZMSUnitsMinor"] call DZMSAISpawn;
sleep 5;
[[(_coords select 0) - 0.5635,(_coords select 1) + 0.3173,0],3,1,"DZMSUnitsMinor"] call DZMSAISpawn;
sleep 5;
[[(_coords select 0) - 0.5635,(_coords select 1) + 0.3173,0],3,1,"DZMSUnitsMinor"] call DZMSAISpawn;
...
diag_log text format["[DZMS]: Minor SM3 Medical Camp Mission has Ended."];
