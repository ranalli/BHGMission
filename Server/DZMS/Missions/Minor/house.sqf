...
[nil,nil,rTitleText,"Bandits have set up a Weapon Stash House! Check your map for the location!", "PLAIN",10] call RE;
...
[[(_coords select 0) - 4.0796, (_coords select 1) - 11.709,0],5,2,"DZMSUnitsMinor"] call DZMSAISpawn;
sleep 3;
