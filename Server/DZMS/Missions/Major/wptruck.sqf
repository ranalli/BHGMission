...
[nil,nil,rTitleText,"A Survivor Weapons Truck has Crashed! Check your map for the location!", "PLAIN",10] call RE;
...
[_coords,3,0,"DZMSUnitsMajor"] call DZMSAISpawn;
sleep 1;
[_coords,3,0,"DZMSUnitsMajor"] call DZMSAISpawn;
sleep 1;
[_coords,3,0,"DZMSUnitsMajor"] call DZMSAISpawn;
...
diag_log text format["[DZMS]: Major SM6 Weapons Truck Mission has Ended."];
