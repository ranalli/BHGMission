...
[nil,nil,rTitleText,"A Survivor Supply Helicopter has been Forced to Land! Stop the Bandits from Taking Control of it!", "PLAIN",10] call RE;
...
[[(_coords select 0) - 8.4614,(_coords select 1) - 5.0527,0],3,1,"DZMSUnitsMajor"] call DZMSAISpawn;
sleep 5;
[[(_coords select 0) - 8.4614,(_coords select 1) - 5.0527,0],3,1,"DZMSUnitsMajor"] call DZMSAISpawn;
sleep 5;
[[(_coords select 0) + 7.5337,(_coords select 1) + 4.2656,0],3,1,"DZMSUnitsMajor"] call DZMSAISpawn;
sleep 5;
...
[nil,nil,rTitleText,"The Helicopter has been Secured by Survivors!", "PLAIN",6] call RE;
