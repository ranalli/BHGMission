...
[[(_coords select 0) + 0.0352,(_coords select 1) - 6.8799, 0],3,1,"DZMSUnitsMajor"] call DZMSAISpawn;
sleep 5;
[[(_coords select 0) + 0.0352,(_coords select 1) - 6.8799, 0],3,1,"DZMSUnitsMajor"] call DZMSAISpawn;
sleep 5;
[[(_coords select 0) + 0.0352,(_coords select 1) - 6.8799, 0],3,1,"DZMSUnitsMajor"] call DZMSAISpawn;
...
diag_log text format["[DZMS]: Major Building Supply Cache Mission has Ended."];
