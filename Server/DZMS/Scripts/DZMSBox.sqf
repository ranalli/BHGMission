...
_bpackList = ["DZ_CivilBackpack_EP1","DZ_Backpack_EP1","DZ_GunBag_EP1","DZ_LargeGunBag_EP1"];
...
_money = ["ItemGoldBar","ItemGoldBar5oz","ItemGoldBar10oz","ItemBriefcase100oz","ItemEmerald"];
